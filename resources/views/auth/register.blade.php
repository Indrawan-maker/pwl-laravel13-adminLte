...
<html lang="en">
  ...
  <head>
    ...
    <link rel="preload" href="{{ asset('themeadmin/css/adminlte.css') }}" as="style" />
    ...
    <link rel="stylesheet" href="{{ asset('themeadmin/css/adminlte.css') }}" />
  ...
  <body class="register-page bg-body-secondary">
    ...
    <script src="{{ asset('themeadmin/css/adminlte.js') }}"></script>
